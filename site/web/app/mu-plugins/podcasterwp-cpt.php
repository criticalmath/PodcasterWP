<?php
/**
 * Plugin Name: CPTs for PodcasterWP
 * Plugin URI: https://github.com/eriteric/PodcasterWP
 * Description: All of the custom post types and taxonomies for PodcasterWP
 * Version: 1.0.0
 * Author: PodcasterWP
 * Author URI: https://github.com/eriteric/PodcasterWP
 * License: MIT License
 */
 ...
 function podcasts() {
 	...
 	$args = array(
 		...
 		'description'           => __( 'List of podcasts', 'text_domain' ),
 		'labels'                => $labels,
